...
import {
    ...
    ElDropdownItem, ElDropdownMenu,ElDrawer,
...
createApp(App).use(store).use(router)
    ...
    .use(ElRow).use(ElCol).use(ElFooter)
    ...
    .use(ElDropdownItem).use(ElDropdownMenu).use(ElDrawer)
    .use(ElOption).use(ElOptionGroup).use(ElOption)
    .mount('#app')
